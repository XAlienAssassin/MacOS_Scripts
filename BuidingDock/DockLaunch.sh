...
sudo -u $currentuser launchctl unload -w /Library/LaunchAgents/com.SAS.builddock.plist
...
sudo -u $currentuser launchctl load -w /Library/LaunchAgents/com.SAS.builddock.plist
